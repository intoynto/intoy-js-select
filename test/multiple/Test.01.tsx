            ...
            <div>
                ...
                <Container asForm>
                    ...
                    <div className="flex gap-3">
                        ...
                        <Select name="kw" fieldid="kw" fieldname="label" multiple options={optionsWilayah} onFieldName={onFieldName} value={set_apply_value?set_apply_value:values.kw} onChange={this.onCh} placeholder="Input Single P?" />
                        <div><input type="text" className="border border-gray-400 rounded" placeholder="Another Input" /></div>
                    </div>
